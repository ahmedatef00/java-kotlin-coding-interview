...
A simple Kotlin-based Rock-Paper-Scissors game simulation that demonstrates clean code principles, SOLID design, and TDD best practices. In this version, the game simulates **100 rounds** where:
...
7. [TDD & Commit Strategy](#tdd--commit-strategy)
